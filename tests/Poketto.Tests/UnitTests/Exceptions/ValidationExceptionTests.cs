...
namespace Poketto.Tests.UnitTests.Exceptions
{
    public class ValidationExceptionTests
    {
        ...
        [Fact]
        public void ValidationFailures_ForMultipleProperties_CreatesAMultipleElementErrorDictionary_EachWithMultipleValues()
        {
            var failures = new List<ValidationFailure>
            {
