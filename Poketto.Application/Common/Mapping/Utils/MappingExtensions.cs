...
namespace Poketto.Application.Common.Mapping.Utils
{
    ...
    {
        public static IEnumerable<TDestination> MapToHierarchy<TSource, TDestination>(this IEnumerable<TSource> source, string sourceChildrenPropName, string destinationChildrenPropName, IMapper mapper)
        {
